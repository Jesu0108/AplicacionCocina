...
-- Volcando datos para la tabla appcocina.alimento: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla appcocina.catador: ~0 rows (aproximadamente)
DELETE FROM `catador`;
...
-- Volcando datos para la tabla appcocina.opinion: ~0 rows (aproximadamente)
DELETE FROM `opinion`;
...
-- Volcando datos para la tabla appcocina.tipo_material: ~0 rows (aproximadamente)
DELETE FROM `tipo_material`;
/*!40000 ALTER TABLE `tipo_material` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipo_material` ENABLE KEYS */;

-- Volcando datos para la tabla appcocina.tipo_servicio: ~0 rows (aproximadamente)
